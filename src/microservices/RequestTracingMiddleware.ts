 ...
 */
export const RequestTracingMiddleware = Object.freeze((): MNextFunction => {
  /**
  ...
  const shouldSampleRequest = (samplingRate: number): boolean => {
  ...
  return {
    ...
    middleware(
      ...
      return async (req: IRequest, res: IResponse, next: NextFunction) => {
        ...
        const traceId =
          (typeof traceIdHeader === 'string' ? traceIdHeader : '') || generateTraceId();
