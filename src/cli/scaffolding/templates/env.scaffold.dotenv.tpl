...
# Options: database | redis | kv | kv-remote | memory
JWT_REVOCATION_DRIVER=database
JWT_REVOCATION_DB_CONNECTION=default
JWT_REVOCATION_DB_TABLE=zintrust_jwt_revocations
BULLETPROOF_DEVICE_DB_CONNECTION=default
BULLETPROOF_DEVICE_DB_TABLE=zintrust_bulletproof_devices
JWT_REVOCATION_REDIS_DB=0
JWT_REVOCATION_REDIS_PREFIX=zt:jwt:revoked:
JWT_REVOCATION_KV_BINDING=CACHE
JWT_REVOCATION_KV_PREFIX=zt:jwt:revoked:
...
# Local dev often uses http; set true in production.
CSRF_COOKIE_SECURE=false
CSRF_COOKIE_HTTP_ONLY=true
CSRF_COOKIE_SAME_SITE=lax

# Comma-separated path globs that skip CSRF checks.
...
# Database overrides (generated by scaffolder)
{{DB_LINES}}
...
SCHEDULE_LEADER_LOCK_PROVIDER=memory
...
JOB_TRACKING_CLEANUP_LOCK_PROVIDER=memory
...
BROADCAST_BRIDGE_PATH=/apps/{appId}/events
BROADCAST_BRIDGE_PROTOCOL=http
WORKER_ISOLATED=false
ZINTRUST_SOCKET_HOST=
ZINTRUST_SOCKET_PORT=
X_ZINTRUST_SOCKET_SEC=
