...
export const Env = Object.freeze({
  ...
  REDIS_RPC_URL: get('REDIS_RPC_URL', ''),
  REDIS_RPC_HOST: get('REDIS_RPC_HOST', '127.0.0.1'),
  REDIS_RPC_PORT: getInt('REDIS_RPC_PORT', 8794),
  REDIS_RPC_SECRET: get('REDIS_RPC_SECRET', PROXY_SECRET_FALLBACK),
  REDIS_RPC_TIMEOUT_MS: getInt('REDIS_RPC_TIMEOUT_MS', ZT_PROXY_TIMEOUT_MS),
  REDIS_RPC_RETRY_MAX: getInt('REDIS_RPC_RETRY_MAX', 2),
  REDIS_RPC_RETRY_DELAY_MS: getInt('REDIS_RPC_RETRY_DELAY_MS', 500),
  ...
  // Zedgi HTTPS transport (Redis/MySQL/Postgres/Queue over HTTPS)
  USE_ZEDGI: getBool('USE_ZEDGI', false),
  ZEDGI_URL: get('ZEDGI_URL', ''),
  ZEDGI_KEY: get('ZEDGI_KEY', ''),
  ZEDGI_SIGNING_SECRET: get('ZEDGI_SIGNING_SECRET', ''),
  ZEDGI_SECRET: get('ZEDGI_SECRET', ''),
  ZEDGI_PUBLIC_KEY: get('ZEDGI_PUBLIC_KEY', ''),
  ZEDGI_ACCOUNT_ID: get('ZEDGI_ACCOUNT_ID', ''),
  ZEDGI_KEY_VERSION: get('ZEDGI_KEY_VERSION', ''),
  ZEDGI_TIMEOUT: getInt('ZEDGI_TIMEOUT', 10000),
  ZEDGI_REDIS_HEADER: get('ZEDGI_REDIS_HEADER', ''),
  ZEDGI_QUEUE_HEADER: get('ZEDGI_QUEUE_HEADER', ''),
  ZEDGI_MYSQL_HEADER: get('ZEDGI_MYSQL_HEADER', ''),
  ZEDGI_POSTGRES_HEADER: get('ZEDGI_POSTGRES_HEADER', ''),
