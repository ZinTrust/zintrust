...
describe('ServiceRequestFactoryGenerator', () => {
  let tempDir: string;
...
describe('ServiceIntegrationTestGenerator', () => {
  let tempDir: string;
...
describe('Priority 7 - Microservices Integration', () => {
  let tempDir: string;
  ...
  it('should generate request factory and integration test together', async () => {
    // Generate request factory
    ...
    // Factory file should have factory class
    ...
    // Test file should have service client
