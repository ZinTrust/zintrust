...
| **Quality**  | [![SonarQube Analysis](https://github.com/ZinTrust/ZinTrust/actions/workflows/sonarqube.yml/badge.svg)](https://github.com/ZinTrust/ZinTrust/actions/workflows/sonarqube.yml) [![Quality Gate Status](https://sonarcloud.io/api/project_badges/measure?project=ZinTrust_ZinTrust&metric=alert_status)](https://sonarcloud.io/summary/new_code?id=ZinTrust_ZinTrust) [![Reliability](https://sonarcloud.io/api/project_badges/measure?project=ZinTrust_ZinTrust&metric=reliability_rating)](https://sonarcloud.io/summary/new_code?id=ZinTrust_ZinTrust) [![Security](https://sonarcloud.io/api/project_badges/measure?project=ZinTrust_ZinTrust&metric=security_rating)](https://sonarcloud.io/summary/new_code?id=ZinTrust_ZinTrust) [![Maintainability](https://sonarcloud.io/api/project_badges/measure?project=ZinTrust_ZinTrust&metric=sqale_rating)](https://sonarcloud.io/summary/new_code?id=ZinTrust_ZinTrust) |
...
| **Coverage** | [![Coverage](https://sonarcloud.io/api/project_badges/measure?project=ZinTrust_ZinTrust&metric=coverage)](https://sonarcloud.io/summary/new_code?id=ZinTrust_ZinTrust) [![Duplications](https://sonarcloud.io/api/project_badges/measure?project=ZinTrust_ZinTrust&metric=duplicated_lines_density)](https://sonarcloud.io/summary/new_code?id=ZinTrust_ZinTrust)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
