...
export default defineConfig(
  {
    ignores: [
      ...
      'test-app/**',
      // Local runtime runners generated by `zin start --deno/--lambda`.
      'tmp/**',
      // Local developer workspace (not tracked in this repo) used for experimenting with configs.
      'zin-tools/**',
      // Auto-generated by plugin system; excluded from tsconfig.json.
